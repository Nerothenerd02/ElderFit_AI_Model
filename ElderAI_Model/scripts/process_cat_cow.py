...
def process_exercise(exercise_name):
    ...
    raw_dir = os.path.join(base_dir, "data", "data", "raw", "yoga", exercise_name)
    processed_dir = os.path.join(base_dir, "data", "data", "processed", "yoga", exercise_name)
